...
<ImgWithText style={{height:"200px",width: "auto"}} url={"https://imgur.com/J2K1eee"} alt={"spreading public key"}>Your public key on the other hand should be openly shared.</ImgWithText>
